...
class AssembleToOrderVar2(AssembleToOrderVanilla):
    def __init__(self, mult=1.0):
        ...
        self._meanValue = 14.996  # 0 # subtracted from evaluation to center the objective function at 0
        # from 50 samples of 20 points each: -14.6896042835
    ...
    def getStringArrivalRates(self):
        ...
        arrivalratep1 = 3.6 - 0.1
        arrivalratep2 = 3 - 0.15
        arrivalratep3 = 2.4 + 0.05
