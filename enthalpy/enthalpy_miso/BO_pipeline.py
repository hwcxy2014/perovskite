...
ns = 2  # total no. of information sources
model = 'single' # for single halide
bu = sh.singleHalide_BU(n,ns,model)

# list all possible solution combinations
