...
function [fn, FnVar, FnGrad, FnGradCov, constraint, ConstraintCov, ConstraintGrad, ConstraintGradCov] = csATO(x, runlength, seed, ar1, ar2, ar3, ar4, ar5, pr1, pr2, pr3, pr5, hc, apt1, apt5, ~)
...
% ar1, ..., ar5 arrival rates of the Poisson processes for products
% other is not used
